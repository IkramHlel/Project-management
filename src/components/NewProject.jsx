    ...
    <>
      <Modal ref={modal} buttonCaption="Okay">
        ...
        <p className="text-stone-600 mb-4 ">
          Oups ... looks like you forgot to enter a value.
        </p>
        <p className="text-stone-600 mb-4 ">
          Please make sure you provide a valid value for every input fiels.
        </p>
      </Modal>
      <div className="w-[35rem] mt-16">
        <menu className="flex justify-end items-center gap-4 my-4">
          <li>
            <button
              className="mx-1 rounded-md text-stone-800 hover:text-stone-950"
              onClick={onCancel}
            >
              Cancel
            </button>
